...
$name_ok = $description_ok = $photo_ok = $price_ok = false;
...
//pemeriksaan session
if (isset($_SESSION['role'])) {//jika sudah login
  if ($_SESSION['role'] != 'Admin') {//jika role akun bukan Admin maka tidak bisa masuk
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                          ...
                          <?php echo
                          "<td><a class='btn btn-success' href='update_user.php?email=$row[email]'>Edit</a> | 
                          <a class='btn btn-danger' href='delete_data_user.php?email=$row[email]' onClick=\"return confirm('Anda yakin akan menghapus record ini?')\">Delete</a></td>"
                          ?>
                      </tr>
                    <?php
                  }
